...
public class MagazzinoUtil {
    ...
    public boolean aggiungereProdotto(Magazzino magazzino, Prodotto prodotto) {
        magazzino.getMagazzino().add(prodotto);
        return true;
    }

    public boolean rimuoviProdotti(Magazzino magazzino, ArrayList<Prodotto> prodottiDaRimuovere) {
    ...
    public ArrayList<Prodotto> cercaProdotti(Magazzino magazzino, ParametroRicerca parametro, String ricerca) {
    ...
    public ArrayList<Prodotto> cercaProdottiRangePrezzo(Magazzino magazzino, double min, double max){
    ...
    public ArrayList<Prodotto> ricercaPerProduttore (Magazzino magazzino, String ricerca){
        ArrayList<Prodotto> result = new ArrayList<Prodotto>();
    ...
    public ArrayList<Prodotto> ricercaPerModello (Magazzino magazzino, String ricerca){
        ArrayList<Prodotto> result = new ArrayList<Prodotto>();
        ...
        return result;
    } public ArrayList<Prodotto> ricercaPerDescrizione (Magazzino magazzino, String ricerca){
        ArrayList<Prodotto> result = new ArrayList<Prodotto>();
        ...
        return result;
    } public ArrayList<Prodotto> ricercaPerDimensione (Magazzino magazzino, String ricerca){
        ArrayList<Prodotto> result = new ArrayList<Prodotto>();
        ...
        return result;
    } public ArrayList<Prodotto> ricercaPerMemoria (Magazzino magazzino, String ricerca){
        ArrayList<Prodotto> result = new ArrayList<Prodotto>();
    ...
    public ArrayList<Prodotto> ricercaPerPrezzoAcquisto (Magazzino magazzino, String ricerca){
        ArrayList<Prodotto> result = new ArrayList<Prodotto>();
    ...
    public ArrayList<Prodotto> ricercaPerPrezzoVendita (Magazzino magazzino, String ricerca){
        ArrayList<Prodotto> result = new ArrayList<Prodotto>();
    ...
    public ArrayList<Prodotto> ricercaPerId (Magazzino magazzino, String ricerca){
        ArrayList<Prodotto> result = new ArrayList<Prodotto>();
